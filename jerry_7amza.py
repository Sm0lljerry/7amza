# Agar Daskariw Krd Naw Labir Maka @ small_jerry1
# instagram : small._.jerry_
# telegram  : small_jerry1
...
\x1b[0m
       ...
       [+] Telegram  : small_jerry1
""")
print('[+] 1- Hamw Reportakan ')
print('[+] 2- Reporte kate \n')
kurd = input('\033[1;36m[+] {1_yan_2} ==> : \x1b[0m')
if kurd == '1':
    time.sleep(1)
    print('''
[+] Orginal Report 
...
''')
    time.sleep(1)
    print('[!] hamu Reportakan ....')
    time.sleep(1)
    print("")
    id1 = input('\033[1;36m[+] nawe TikTok??? ==> : \x1b[0m')
    print('[+] Report daste pekrd...')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
            print('\033[1;92m[+] Report Orginal Has Been Sent')
        else:
            print('\033[0;92m[+] Sent Report Orginal')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            print('\033[1;92m[+] Report Hate Speech Has Been Sent')
        else:
            print('\033[0;92m[+] Sent Report Hate Speech')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
            ...
            print('\033[0;92m[+] sent Report Suicide, Self')
if kurd == '2':
    print('''
[+] 1- Orginal Report 
...
''')
kurd2 = input('\033[1;92m[+] Choose ==> : \x1b[0m')
if kurd2 == '1':
    username = input('\033[1;92m[+] User Target ==> : \x1b[0m')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req5:
            print('\033[1;92m[+] Report Has Been Sent')
        else:
            print('\033[0;92m[+] sent Report')
if kurd2 == '2':
    username2 = input('\033[1;92m[+] User Target ==> : \x1b[0m')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req6:
            ...
            print('\033[0;92m[+] Sent Report')
if kurd2 == '3':
    username3 = input('\033[1;92m[+] User Target ==> : \x1b[0m')
